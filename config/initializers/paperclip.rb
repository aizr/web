...
Paperclip.interpolates :year do |attachment, style| attachment.instance.created_at.strftime("%Y")
end

Paperclip.interpolates :month do |attachment, style| attachment.instance.created_at.strftime("%m")
end
